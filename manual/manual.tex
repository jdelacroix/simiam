...
This manual is going to be your resource for using the simulator in the programming exercises included in this manual. It will be updated from time to time whenever new features are added to the simulator.

\subsection{Installation}

Download \texttt{simiam-coursera-week-X.zip} (where X is the corresponding week for the exercise) from \href{https://github.com/jdelacroix/simiam/tags}{https://github.com/jdelacroix/simiam/tags}. Make sure to download a new copy of the simulator \textbf{before} you start a new week's programming exercises, or whenever an announcement is made that a new version is available. It is important to stay up-to-date, since new versions may contain important bug fixes or features required for the programming exercises.
...
If you run into a bug (issue) with the simulator, please create a issue on GitHub at 

\noindent\href{https://github.com/jdelacroix/simiam/issues}{https://github.com/jdelacroix/simiam/issues}. Make sure to leave a detailed description of the bug, including any relevant information, such as the version of MATLAB.
...
\subsection{Week 2}
Start by downloading the robot simulator for this week from \href{https://github.com/jdelacroix/simiam/tags}{https://github.com/jdelacroix/simiam/tags}. Before you can design and test controllers in the simulator, you will need to implement three components of the simulator:
...
Start by downloading the new robot simulator for this week from \href{https://github.com/jdelacroix/simiam/tags}{https://github.com/jdelacroix/simiam/tags}. This week you will be implementing the different parts of a PID regulator that steers the robot successfully to some goal location. This is known as the go-to-goal behavior:
