...
%             set(obj.parent_, 'Renderer', 'painters');
            ...
            qrcode_fex = fullfile(obj.root_, 'resources/qrcode_fex.png');
            if(isunix)
                icon_url = ['file://' icon_file];
                qrcode_fex_url = ['file://' qrcode_fex];
            else
                icon_url = strrep(['file:/' icon_file],'\','/');
                qrcode_fex_url = strrep(['file:/' qrcode_fex],'\','/');
            end
            button_string = ['<html><div style="text-align: center"><img src="' qrcode_fex_url '"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="' icon_url '"/>' ...
                             '<br>Welcome to <b>Sim.I.am</b>, a robot simulator.' ...
                             '<br>This is <em>Sim the Third</em>, your Robot Zombie survival consultant.' ...
                             ...
                             '</div><br><ol><li>Start the game by clicking the play button.</li><li>Use the mouse to pan and zoom.</li><li>Double click anywhere on the grid to drive to that location.</li><li>Select the robot to follow it.</li><li>If your robot crashes or is captured by the robot zombie, press the rewind button.</li></ol>' ...
                             '</html>'];
...
%             delete(obj.parent_);
            ...
            set(obj.view_, 'XColor', obj.ui_colors_.gray);
            set(obj.view_, 'YColor', obj.ui_colors_.gray);
